...
function sacchaone_customize_register( $wp_customize ) {
	...
	*/
	 ...
	 */
	$wp_customize->add_section(
		'sacchaone_typography_section',
		array(
			'title'    => __( 'Heading 1 (H1)', 'sacchaone' ),
			'priority' => 70,
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_font_family',
			'type'		  => 'select',
			'choices'     => array(
					'default' 		=> __('Default','sacchaone'),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typography_setting',
			'type'		  => 'select',
			'choices'     => array(
					'default' 		=> __('Default','sacchaone'),
	 ...
	 */
	$wp_customize->add_setting(
		'sacchaone_typo_font_style_setting',
		array(
			'default'  =>'default',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_font_style_setting',
			'type'		  => 'select',
			'choices'     => array(
					'default' 		=> __('Default','sacchaone'),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_text_transform',
			'type'		  => 'select',
			'choices'     => array(
					'default' 		=> __('Default','sacchaone'),
	...
	*/
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_font_size',			
		)
	);
	...
	*/
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_line_height',			
		)
	);
	...
	*/
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'	  => 'sacchaone_typography_section',
			'setting'	  => 'sacchaone_typo_letter_spacing',			
		)
	);
	 ...
	 */
	$wp_customize->add_setting(
		'setting_for_font_color',
		array(
			'default'           => $defaults['setting_for_font_color'],
			'transport'         => 'postMessage',
			'sanitize_callback' => 'sanitize_hex_color',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'section'  => 'sacchaone_typography_section',
				'settings' => 'setting_for_font_color',
			)
		)
	);
}
